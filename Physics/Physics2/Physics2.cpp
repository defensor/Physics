...
// Physics2.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPhysics2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CPhysics2App

CPhysics2App::CPhysics2App()
{
...
// Единственный объект CPhysics2App

CPhysics2App theApp;


// инициализация CPhysics2App

BOOL CPhysics2App::InitInstance()
{
